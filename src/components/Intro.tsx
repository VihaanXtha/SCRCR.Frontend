...
// Intro Component: Displays the "Who We Are" section on the homepage
// Props:
// - t: Translation function
// - lang: Current language
// - navigate: Function to handle navigation
export default function Intro({ t, lang, navigate }: { t: (k: string) => string; lang: 'en' | 'ne'; navigate: (path: string) => void }) {
  return (
    <section className="w-full max-w-7xl mx-auto py-12 px-4">
      <div className="flex flex-col md:flex-row gap-8 lg:gap-16 items-center">
        {/* Left Column: Photo with decorative background elements */}
        <div className="relative w-full md:w-5/12 flex justify-center items-center group">
          {/* Decorative background shapes (rotated rectangles) */}
        ...
        <div className="w-full md:w-7/12">
          <div className="bg-gradient-to-br from-gray-50 to-white rounded-[2.5rem] p-8 md:p-12 shadow-lg border border-gray-100 relative h-full flex flex-col justify-center items-center text-center transform transition-all duration-500 hover:shadow-xl">
            ...
            <div className="relative z-10 flex flex-col items-center">
              ...
              <button 
                ...
                className="btn hover:scale-105 transform transition-transform duration-200 shadow-md"
              >
