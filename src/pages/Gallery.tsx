    ...
    <div className="page pb-20">
      ...
      <div className="w-full max-w-7xl mx-auto px-4 py-6 md:py-8">
        ...
        <div className="flex flex-wrap justify-center gap-2 md:gap-3 mb-6 px-1">
          <button 
            className={`flex-1 md:flex-none shrink-0 px-4 py-3 md:px-6 md:py-2 rounded-full font-bold transition-all text-sm md:text-base ${filter === 'all' ? 'bg-[#e43f6f] text-white shadow-md' : 'bg-white text-gray-600 hover:bg-gray-100'}`}
            onClick={() => setFilter('all')}
          >
            {t('gallery.filter.all')}
          </button>
          <button 
            className={`flex-1 md:flex-none shrink-0 px-4 py-3 md:px-6 md:py-2 rounded-full font-bold transition-all text-sm md:text-base ${filter === 'photo' ? 'bg-[#e43f6f] text-white shadow-md' : 'bg-white text-gray-600 hover:bg-gray-100'}`}
            onClick={() => setFilter('photo')}
          >
            {t('gallery.filter.photo')}
          </button>
          <button 
            className={`flex-1 md:flex-none shrink-0 px-4 py-3 md:px-6 md:py-2 rounded-full font-bold transition-all text-sm md:text-base ${filter === 'video' ? 'bg-[#e43f6f] text-white shadow-md' : 'bg-white text-gray-600 hover:bg-gray-100'}`}
            onClick={() => setFilter('video')}
          >
            {t('gallery.filter.video')}
          </button>
          <button 
            className={`flex-1 md:flex-none shrink-0 px-4 py-3 md:px-6 md:py-2 rounded-full font-bold transition-all text-sm md:text-base ${filter === 'album' ? 'bg-[#e43f6f] text-white shadow-md' : 'bg-white text-gray-600 hover:bg-gray-100'}`}
