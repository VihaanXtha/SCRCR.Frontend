            ...
            <div className="section mb-16">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="bg-white rounded-[2rem] overflow-hidden shadow-lg hover:shadow-2xl transition-all group">
                  ...
                  <div className="p-6">
                    <h4 className="text-xl font-bold mb-2 text-gray-800">Daily Yoga & Meditation</h4>
                    <p className="text-sm text-[#e43f6f] font-bold uppercase tracking-wider">Every morning 6:00 AM - 7:30 AM</p>
                  </div>
                </div>
                <div className="bg-white rounded-[2rem] overflow-hidden shadow-lg hover:shadow-2xl transition-all group">
                  <div className="h-48 overflow-hidden">
                  ...
                  <div className="p-6">
                    <h4 className="text-xl font-bold mb-2 text-gray-800">Monthly Health Checkup</h4>
                    <p className="text-sm text-[#e43f6f] font-bold uppercase tracking-wider">First Saturday of every month</p>
                  </div>
                </div>
                <div className="bg-white rounded-[2rem] overflow-hidden shadow-lg hover:shadow-2xl transition-all group">
                  <div className="h-48 overflow-hidden">
                  ...
                  <div className="p-6">
                    <h4 className="text-xl font-bold mb-2 text-gray-800">Bhajan Kirtan</h4>
                    <p className="text-sm text-[#e43f6f] font-bold uppercase tracking-wider">Every evening 5:00 PM - 7:00 PM</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="section">
              ...
              <div className="bg-white rounded-[2rem] p-6 md:p-8 shadow-lg border border-gray-100 flex flex-col md:flex-row gap-8 items-center">
                ...
                <div className="flex-1">
                  <h4 className="text-2xl font-bold text-gray-800 mb-4">Winter Relief Distribution Program</h4>
                  <p className="text-gray-600 mb-6 text-lg leading-relaxed">We are distributing warm clothes and blankets to senior citizens in need during this winter season. Join us in this noble cause to help our elders stay warm.</p>
                  <button className="px-8 py-3 bg-[#e43f6f] hover:bg-[#c6285b] text-white font-bold rounded-full shadow-lg transition-all transform hover:-translate-y-1">Learn More</button>
                </div>
              </div>
            </div>
          </AnimatedSection>
